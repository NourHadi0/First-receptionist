                ...
                <div className="add-Record-container">
                    <div className="add-form-box">
                        <div className="add-progress">
                            <div className="add-logo"><a href="/"><span>إنشاء سجل طفل</span></a></div>
                            <ul className="progress-steps">
                                ...
                                <li className="step">
                                    <span>3</span>
                                    <p>ولي الأمر<br /><span>تسجيل بيانات الشخص المسؤول عن الطفل</span></p>
                                </li>
                            </ul>
                        </div>
                        <form>
                            <div className="form-one form-step active">
                                ...
                                <p>بعد أخذ بيانات الطفل قم بتسجيلها كما هي.</p>
                                <div>
                                    <label>الاسم</label>
                            ...
                            <div className="form-three form-step">
                                ...
                                <p>قم بتسجيل بيانات شخص قريب من الطفل</p>
                                <div>
                                    <label>الاسم</label>
